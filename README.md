...
Create a basic HTML web page - My goal was to create a page that looked a little rough. An alien page hastily made by someone in a basement somewhere. For example, what an alien website might look like in a movie or something.
...
Level 2: Multiple Search Categories (Optional) - I tried my best at this optional part, though I'm not sure I got the code working correctly.
